...
# NACL
variable "web_dedicated_network_acl" {
  description = "Whether to use dedicated network ACL (not default) and custom rules for web subnets"
  default     = false
}

variable "web_inbound_acl_rules" {
  description = "web subnets inbound network ACLs"
...
variable "web_outbound_acl_rules" {
  description = "web subnets outbound network ACLs"
...
variable "notification_subnets" {
  description = "A list of notification subnets inside the VPC"
  type = list(string)
  default     = []
}

# NACL
variable "notification_dedicated_network_acl" {
  description = "Whether to use dedicated network ACL (not default) and custom rules for notification subnets"
  default     = false
}

variable "notification_inbound_acl_rules" {
  description = "notification subnets inbound network ACLs"
...
variable "notification_outbound_acl_rules" {
  description = "notification subnets outbound network ACLs"
...
variable "captcha_subnets" {
  description = "A list of captcha subnets inside the VPC"
  type = list(string)
  default     = []
}

# NACL
variable "captcha_dedicated_network_acl" {
  description = "Whether to use dedicated network ACL (not default) and custom rules for captcha subnets"
  default     = false
}

variable "captcha_inbound_acl_rules" {
  description = "captcha subnets inbound network ACLs"
...
variable "captcha_outbound_acl_rules" {
  description = "captcha subnets outbound network ACLs"
